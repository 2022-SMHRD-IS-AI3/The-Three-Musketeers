...
<div class="login-box">
  <h2>버튼관리</h2>
  <form action="main_edit_con">
    <div class="user-box">
      <input type="text" name="zoom" required="" value="<%=btn_arr.getZoom() %>">
      <label>줌주소</label>
    </div>
    <div class="user-box">
      <input type="text" name="recode" required="" value="<%=btn_arr.getRecode() %>">
      <label>녹화영상</label>
    </div>
    <div class="user-box">
      <input type="text" name="longtime" required="" value="<%=btn_arr.getLongtime() %>">
      <label>연장신청</label>
    </div>
    <table align="center">
    <tr>
